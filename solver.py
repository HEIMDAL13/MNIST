        ...
        if opt.optimizer == 'SGD':
            ...
            if opt.dlr:
                ...
                if opt.greyscale:
                    ...
                    self._optimizer = optim.SGD([{'params': [param for name, param in model.named_parameters() if 'fc3' not in name]},{'params': model.fc3.parameters(), 'lr': opt.dlr}], lr=opt.lr, momentum=opt.momentum,weight_decay=opt.weight_decay)
        else:
