...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dlr', type=float, default=0, metavar='LR',help='learning rate (default: 0.01)')
        ...
        self.parser.add_argument('--second_size', type=int, default=1024, help='size second fc layer')
        self.parser.add_argument('--third_size', type=int, default=512, help='size third fc layer')
        ...
        self.parser.add_argument('--drop3', type=float, default=0, help='dropout prob')
        self.parser.add_argument('--drop4', type=float, default=0, help='dropout prob')
        self.parser.add_argument('--batch_norm1', type=int, default=0, help='batch normalization after first layer of fully conected')
        self.parser.add_argument('--batch_norm2', type=int, default=0, help='batch normalization after second layer of fully conected')
